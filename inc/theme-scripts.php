...
if (! function_exists('theme_scripts')) {
    function theme_scripts()
    {
        ...
        wp_enqueue_style('alqa_signals-style', get_template_directory_uri() . '/assets/css/style.css', array(), mt_rand());
        wp_enqueue_style('alqa_signals-responsive-style', get_template_directory_uri() . '/assets/css/responsive.css', array(), mt_rand());

        // Enqueue main script file
        wp_enqueue_script('alqa_signals-script', get_template_directory_uri() . '/assets/js/script.js', array('jquery'), mt_rand(), true);

        // Localize the script with new data
        wp_localize_script('alqa_signals-script', 'alqa_signals', array(
